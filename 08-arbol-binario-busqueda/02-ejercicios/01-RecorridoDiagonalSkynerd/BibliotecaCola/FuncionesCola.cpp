...
void encolar(struct Cola& cola, const struct ElementoArbolBinarioBusqueda& elemento) {
...
struct ElementoArbolBinarioBusqueda desencolar(struct Cola& cola) {
    struct NodoCola* sale = cola.inicio;
    struct ElementoArbolBinarioBusqueda elemento = sale->elemento;
