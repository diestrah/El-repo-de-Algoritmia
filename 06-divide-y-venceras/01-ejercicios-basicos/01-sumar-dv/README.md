# Suma de Array con Divide y Vencerás

## Enunciado

Dado un arreglo de números enteros, implementa un algoritmo recursivo utilizando 
la técnica de **divide y vencerás** para calcular la suma total de sus elementos.
